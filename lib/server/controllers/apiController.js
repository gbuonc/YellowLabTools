    ...
    app.post('/api/runs', function(req, res) {
        ...
        var run = {
            ...
            params: {
                ...
                noExternal: req.body.noExternal,
        ...
        queuePromise.then(function() {
            ...
            var runOptions = {
                ...
                noExternal: run.params.noExternal,
        ...
        // log wheter external request are loaded or not
        if (run.params.noExternal) {
            console.log('External request are disabled.');
        }
